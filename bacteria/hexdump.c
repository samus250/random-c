/***************************************************************************
 *   hexdump.c - Written by samus250, Copyright (C) 2008.                  *
 *   Generates a C array containing hex data for a given file.             *
 *                                                                         *
 ***************************************************************************/
...
{
    printf(
        "Usage: [input file] [output file] [array name]\n"
    );
    return;
}
...
void write_data(FILE *output, char name[], unsigned long long filesize, unsigned char *data)
{
    unsigned long long x = 0;
